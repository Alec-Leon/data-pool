...
что дало бы им больше очков.<br><br>

> Для миссий на Уровне Наемников (DLC "Соло Удачи 2045") О.У. остаются прежними, за исключением того,
> что каждая миссия наёмников, которую вы пережили, засчитывается, как минимум, как **Успешная Миссия** при распределении групповых О.У.
